...
confident-metrics project is [Apache licensed](LICENSE.md) and accepts contributions via GitHub 
pull 
...
By contributing to this project you agree to the [Developer Certificate of Origin \(DCO\)](https://github.com/src-d/confident-metrics/DCO). This document was created by the Linux Kernel 
community and is a simple statement that you, as a contributor, have the legal right to make the contribution.
...
* GitHub [issues](https://github.com/src-d/confident-metrics/issues)\*
...
* In any case, all the PRs have to pass the personal evaluation of at least one of the [maintainers](https://github.com/src-d/confident-metrics/MAINTAINERS.md).
